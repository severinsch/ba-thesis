...
\begin{table}[H]
	...
	\begin{tabular}{cccc}
		...
		\midrule
		\makecell{\cite{amnesia_evaluation, amnesia}} & \makecell{prevent SQL injection\\attacks} & \makecell{JSA \& runtime monitoring} & \makecell{\checkmark} \\
		\midrule
