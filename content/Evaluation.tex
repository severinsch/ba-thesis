...
The test cases are grouped by the type of flaw, each corresponding to a specific CWE\footnote{https://cwe.mitre.org} entry, they target. All 2224 test cases we analyzed target SQL-Injection vulnerabilities described in CWE-89, as these are flaws, where strings and string operations are the relevant points, while also being relevant risks in real applications.
