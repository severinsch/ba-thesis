...
We analyze the resulting regular expressions of two synthetic code examples, one from Christensen et al. \cite{brics} and one custom example. We also analyze the results for the SQL Injection test cases of the Juliet test suite\footnote{https://samate.nist.gov/SARD/test-suites/111}.
...
Further, we measured the execution time of the different steps in our analysis approach. As in the previous section we considered the two synthetic examples and the test cases of the Juliet test suite. 
